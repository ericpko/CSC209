 ...
 */
int set_up_server_socket(struct sockaddr_in *server_addr, int num_queue) {
    ...
    if (bind(listen_soc, (struct sockaddr *)server_addr,
...
int accept_connection(int listenfd) {
    ...
    // remember that accept is a blocking system call
